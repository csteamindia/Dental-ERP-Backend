...
// Api
// Comapany
$route['company'] 						= 			'org/company'; 
$route['company/(:any)']                = 			'org/company/$1';

// Department
$route['masters'] 						= 			'org/masters'; 
$route['master/(:any)']                 = 			'org/masters/$1';
$route['privatization/(:any)']          = 			'org/masters/privatization/$1';

// Products
$route['products']                      = 			'product/products';
$route['privatization/(:any)']          = 			'org/masters/$1';
$route['products/options']              = 			'product/products/options';
$route['products/options/(:any)']       = 			'product/products/options/$1';

// Employee
$route['employee'] 					    = 			'employee/employee';

// Client
$route['clients'] 					    = 			'org/clients/Clients';
