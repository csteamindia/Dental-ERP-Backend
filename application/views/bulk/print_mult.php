        ...
        <table border="1" style="width: 100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>&nbsp;Sub Total &nbsp; </td>
              <th>&nbsp;<?= number_format(str_replace(',','',$i->invoice_subtotal));?></th>
            </tr>
            <tr>
              ...
              <th colspan='1'>
                <table border="1" width="100%">
                  <?php if($i->invoice_gst_amount > 0) {?>
                    <tr>
                      <td>IGST@<?= number_format(str_replace(',','',$i->igst));?></td>
                    </tr>
                    <tr>
                      <td>CGST@<?= number_format(str_replace(',','',$i->cgst));?></td>
                    </tr>
                    <tr>
                      <td>SGST@<?= number_format(str_replace(',','',$i->sgst));?></td>
                    </tr>
                  <?php } ?>
                  <tr>
              ...
              <td colspan='3'>
                <table border="1" width="100%">
                  ...
                  <?php } ?>
                  <tr>
                    <td colspan="3">&nbsp;<?= number_format(($i->invoice_total));?>/-</td>
                  </tr>
                </table>
              </td>
            </tr>
