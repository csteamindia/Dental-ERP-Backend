  ...
  <div class="col-md-12">
    <div class="panel">
      <div class="box-header">
        <h3 class="box-title"><?= get_clientname($id);?> Price Bands</h3>
        <a href="<?= base_url('clients/addclientproducts/') . $id; ?>" title="Add Product Price band" class="btn btn-primary add"><i class="fa fa-plus"></i> Add</a>
        <!-- <button class="btn btn-primary add" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i> Add</button> -->
        <a href="<?= base_url('clients/priceband_report/' . $id); ?>" title="Download All Client Product Price Bands" target="_blank" class="btn btn-primary add" style="margin-right: 15px"><i class="fa fa-download"></i></a>
      </div>
